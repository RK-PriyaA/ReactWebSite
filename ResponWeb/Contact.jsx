...
const Contact = () =>{
    ...
    const formSubmit = (e) =>{
        e.preventDefault();
        alert(`My name is ${data.fullname}. My mobile number is ${data.phone}. My email is ${data.email}, Here is what I watn to say ${data.msg}`);
    }
    return(
        <>
        <div className="my-5">
                ...
                <div className="col-md-6 col-10 mx-auto">
                 <form onSubmit={formSubmit}>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control" id="exampleFormControlInput1" name="phone" value={data.phone} onChange={InputEvent} placeholder="Enter Your PhoneNumber"/>
                    </div>
                    <div class="mb-3">
